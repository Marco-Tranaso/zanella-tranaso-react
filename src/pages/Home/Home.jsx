  ...
  return (
    <div className='home'>
      ...
      <div className="more-cards">
        ...
        <TitleCards title={"Solo su Netflix"} category={"popular"} />
        <TitleCards title={"Prossimamente su Netflix"} category={"upcoming"} />
        <TitleCards title={"Scelti per te"} category={"now_playing"} />
      </div>
      <Footer />
    </div>
  )
